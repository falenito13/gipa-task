...
<div class="main-card">
    ...
    <form method="POST" action="{{ route("admin.product.store") }}" enctype="multipart/form-data">
        ...
        <div class="body">
            <div class="mb-3">
                <label for="title" class="text-xs required">{{ trans('cruds.product.fields.name') }}</label>

                <div class="form-group">
                    <input type="text" id="name" name="name" class="{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}">
                </div>
                @if($errors->has('name'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="price" name="price" class="{{ $errors->has('price') ? ' is-invalid' : '' }}" value="{{ old('price') }}">
                </div>
                @if($errors->has('price'))
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="quantity" name="quantity" class="{{ $errors->has('quantity') ? ' is-invalid' : '' }}" value="{{ old('quantity') }}">
                </div>

...
use App\Http\Requests\Broadcaster\StoreBroadcasterRequest;
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::delete('newsdestroy', 'ProductController@massDestroy')->name('product.massDestroy');
...
Route::group(['namespace' => 'Api\V1'],function(){
   Route::get('/test/{query}','ApiController@search');
});
